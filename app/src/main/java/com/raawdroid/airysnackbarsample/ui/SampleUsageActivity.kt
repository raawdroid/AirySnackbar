...
import com.raawdroid.airysnackbar.AnimationAttribute
import com.raawdroid.airysnackbar.GravityAttribute
...
import com.raawdroid.airysnackbar.SizeUnit
import com.raawdroid.airysnackbar.SoundAttribute
...
import com.raawdroid.airysnackbarsample.databinding.ActivitySampleBinding
        ...
        with(binding) {
            ...
            buttonSound.setOnClickListener {
                AirySnackbar.make(
                    ...
                    type = Type.Custom(bgColor = com.raawdroid.airysnackbar.R.color.mustardy),
                    attributes =
                    listOf(
